			...
			<nav className={cl.nav}>
				<ul>
					<li className={'pt-4 pr-5 pb-4 pl-5 '}>
						<Link className={clsx('text text_type_main-default', {['text_color_inactive']: currentPath !== '/'})}
									to={'/'}>
					...
					<li className={'pt-4 pr-5 pb-4 pl-5'}>
						<Link className={clsx('text text_type_main-default', {['text_color_inactive']: currentPath !== '/order'})}
									to={'/order'}>
				...
				<Link className={clsx('text text_type_main-default', {['text_color_inactive']: currentPath !== '/profile'})}
							to={'/profile'}>
